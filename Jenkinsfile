      ...
      stage("K8S Deployment"){
            ...
            sh "chmod +x changeTag.sh"
                ...
                sshagent(['KOPS-WORKSTATION']) {
                    sh "ssh ubuntu@ec2-52-74-34-239.ap-southeast-1.compute.amazonaws.com rm -rf /home/ubuntu/bow/api/"
                    sh "ssh ubuntu@ec2-52-74-34-239.ap-southeast-1.compute.amazonaws.com mkdir -p /home/ubuntu/bow/api/"
                    ...
                    script{
                        try{
                            sh "ssh ubuntu@ec2-52-74-34-239.ap-southeast-1.compute.amazonaws.com kubectl apply -f /home/ubuntu/bow/api/api_bow.yml"
                        }catch(error){
